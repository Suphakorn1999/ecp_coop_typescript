class FM10_14verrify {
  static datafm10_14 = (formdata: any[], fm10_14: any[]) => {
    let data: any[] = [];
    formdata.forEach((element) => {
      let fm = fm10_14.filter(
        (item) => item.idfm10_14data == element.idfm10_14data,
      );
      data.push({
  ...
  static pushfm = (fm10_14: any[], fm10_14coop: any[], data: any[]) => {
    data.forEach((d) => {
      fm10_14coop.forEach((a) => {
        fm10_14.forEach((e) => {
          if (
            d.idfm10_14data == a.idfm10_14data &&
  ...
  static datatotalpoint = (formdata: any[], fm10_14: any[]) => {
    let data: any[] = [];
    formdata.forEach((element) => {
      let fm = fm10_14.filter(
        (item) => item.idfm10_14data == element.idfm10_14data,
  ...
  static pushtotalpoint = (fm10_14: any[], data: any[]) => {
    data.forEach((d) => {
      fm10_14.forEach((e) => {
