...
export const updateFm10_13cooptotal: RequestHandler = async (req, res, next) => {
    const idfm10_13_coop: any = req.body.idfm10_13_coop;
    const total_score: any = req.body.total_score;
    const updatedAt: any = req.body.updatedAt;
